...
class HomeDacController extends Controller
{
    ...
    public function colaDac(){
        ...
        $evidencias = Evidencia::where('estado','Pendiente')
                                ...
                                ->select('profesor.*','formularios.fecha_realizacion','formularios.titulo','carreras.nombre_car','evidencias.id','evidencias.created_at as fecha_creacion','evidencias.id as evidencia_id')
                                ->paginate(8);
