...
<html>
	<head>
		<title>Gesion Evidencias | UCM</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<div id="header" style="padding-top:0px;">
					<!-- Nav -->
						<nav id="nav">
							<ul style="padding-left: 0em;padding-right: 37em;">          
								<li><img src="{{asset("img/logo-banner.png")}} " style="height:48px;widht:30px;"></li>
								<li class="current"><a href="#">SISTEMA GEV</a></li>
								<li><a href="left-sidebar.html">PORTAL UCM</a></li>
								<li><a href="right-sidebar.html">FUNCIONARIOS</a></li>
								<li><a href="two-sidebar.html">ACADÉMICOS</a></li>
								<li><a href="no-sidebar.html">WEBMAIL</a></li>
							</ul>
						</nav>
			...
			<!-- Banner -->
				<section id="banner">
					<header>
						<h2><em>Bienvenido a SISGEV tu Sistema Gestor de Evidencias</em></h2>
						<a href="{{ route('login') }}" class="button">Ingresa Aqui</a>
					</header>
				</section>
            ...
            <div class="footer-content">
                ...
                <div class="footer-bottom" style="padding-left: 11em;">
                    <div class="links">
                        <div class="container">
