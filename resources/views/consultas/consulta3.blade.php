  ...
  <div class="col-md-6">
    <div class="box box-danger">
      <div class="box-header with-border">
        <h3 class="box-title">Cantidad de evidencias por carrera</h3>
    ...
    //CHART 1
      var donut = new Morris.Donut({  
        ...
        data: [
          ...
          {label: "Ing civil informatica", value: 3},
          {label: "Ing civil industrial", value: 2},
          {label: "Ing civil en construccion", value: 1}
        ],
        hideHover: 'auto'
